...
public class MapBuilder {
	...
	private void buildRoads() {
		...
		roads.put("EastWest", new Road(new Point(420, 640), new Point(780, 640), Direction.EAST, true, true));
	}
	...
	private void buildTracks() {
		...
		tracks.put("Layor", new RailwayTracks(new Point(0, 560), new Point(1200, 560)));
	}
