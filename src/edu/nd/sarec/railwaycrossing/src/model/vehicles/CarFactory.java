...
/**
 * Very basic car factory. Creates the car and registers it with the crossing
 * gate and the car infront of it.
 * 
 * @author jane
 *
 */
public class CarFactory {
	...
	// We will get a concurrency error if we try to delete cars whilst iterating
	// through the array list
	// so we perform this in two stages.
	// 1. Loop through the list and identify which cars are off the screen. Add them
	// to 'toDelete' array.
...
//		for (Car car : cars) {
//			if (car.removeObservers()) {
//				for (CrossingGate gate : gates) {
//					gate.deleteObserver(car);
//				}
//			}
//		}
